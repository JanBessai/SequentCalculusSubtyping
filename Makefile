...
# coq_makefile SequentConstructors.v -o Makefile 
#
...
.merlin:
	...
	@echo "B /home/jan/projects/SequentConstructors" >> .merlin
	@echo "S /home/jan/projects/SequentConstructors" >> .merlin
